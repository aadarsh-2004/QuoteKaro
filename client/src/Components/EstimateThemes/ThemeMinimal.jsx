...
const ThemeMinimal = ({ estimate, studio, onGoBack }) => {
  ...
  return (
    <div className="min-h-screen bg-white p-4 sm:p-6 flex flex-col items-center">
      ...
      <div
        ref={printRef}
        className="pl-68 md:p-0 mx-auto font-sans text-gray-900 bg-white shadow-lg rounded-lg overflow-hidden md:shadow-none md:rounded-none estimate-container"
        style={captureStyles}
      >
